  ...
  for (let event of eventsArr) {
    ...
    container.innerHTML += `<div class="event shadow">
        <div class="event-left d-flex flex-column">
            ...
            <div class="event-subtitle d-flex">${
              getOrganizerById(event.organizerId, organizersArr).name
            }</div>
            <div class="tags-input d-flex gap-2">${displayTags(
              event.tags
            )}</div>
          <div class="location d-flex">
            <div class="d-flex align-items-center gap-1">
              <img
                src="./Images/Location.svg" alt="location-icon" class="border-0"/>
